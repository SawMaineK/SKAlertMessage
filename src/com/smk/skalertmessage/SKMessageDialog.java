...
public class SKMessageDialog extends Dialog{
    private static SKMessageDialog instance;
    ...
    public SKMessageDialog(Activity activity) {
        super(activity);
    ...
    public static SKMessageDialog getInstance(Activity activity) {
        if(instance == null){
            instance = new SKMessageDialog(activity);
        }
        instance.init();
        return instance;
    }
